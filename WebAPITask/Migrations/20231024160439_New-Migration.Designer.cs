...
namespace WebAPITask.Migrations
{
    ...
    [Migration("20231024160439_New-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Context.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Order", b =>
                {
                    ...
                    b.Property<string>("CompleteOrderStatus")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Tracking", b =>
                {
                    b.Property<Guid>("TrackingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Address", b =>
                {
                    b.HasOne("DataAccessLayer.Context.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("DataAccessLayer.Models.OrderItems", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Models.Tracking", "Tracking")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DataAccessLayer.Context.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
